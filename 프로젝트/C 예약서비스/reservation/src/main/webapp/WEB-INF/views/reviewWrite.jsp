...
<body>
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title review_header">
                    <a href="/reservation/myreservation?resrv_email=<%= email %>" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                    <h2><span class="title"><!-- 상품명 --></span></h2>
                </div>
                <!-- 리뷰 별점 -->
                <div class="write_act">
                ...
                <div class="review_contents write">
                    ...
                    <textarea cols="30" rows="10" class="review_textarea" minlength="5" maxlength="400"></textarea>
                </div>
                <!-- //리뷰 입력 -->
    ...
    <script src="resources/script/reviewWrite.js"></script>
</body>
</html>