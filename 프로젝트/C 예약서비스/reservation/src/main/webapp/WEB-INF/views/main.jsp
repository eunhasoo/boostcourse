...
<body>
    <div id="container">
        <div class="header">
            <header class="header_tit">
                ...
                <a href="#" class="btn_my"> <span class="viewReservation" title="예약확인"><%= email.equals("") ? "예약확인" : email %></span> </a>
            </header>
        </div>
        <hr>
        <div class="event">
    ...
    <li class="item" data-index={id} style="background-image: url(http://localhost:8090/reservation/resources/img/{productImageUrl});">
