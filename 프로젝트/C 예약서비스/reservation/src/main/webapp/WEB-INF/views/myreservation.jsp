...
<script type="rv-template" id="confirmed-item">
      ...
      <div class="left"></div>
        <div class="middle">
          ...
          <div class="booking_cancel">
            <button class="btn" id="{{reservationId}}"><span>취소</span></button>
          </div>
          </div>
          </div>
          <div class="right"></div>
...
<script type="rv-template" id="used-item">
<article class="card_item">
  <a href="#" class="link_booking_details">
    <div class="card_body">
      <div class="left"></div>
        <div class="middle">
          ...
          <!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
          <div class="booking_cancel" id="{{productId}}">
            <button class="btn" id="{{reservationId}}"><span id="{{displayInfoId}}">예매자 리뷰 남기기</span></button>
          </div>
          </div>
          </div>
          <div class="right"></div>
...
<script type="rv-template" id="canceled-item">
<article class="card_item">
  <a href="#" class="link_booking_details">
    <div class="card_body">
      <div class="left"></div>
        <div class="middle">
          ...
          <div class="price_summary">
            <span class="price_tit">결제취소 금액</span>
            <em class="price_amount">
            <span>{{total}}</span>
            <span class="unit">원</span>
            </em>
  ...
  <a href="#" class="fn fn-share1 naver-splugin btn_goto_share" title="공유하기"></a>
    ...
    <script src="resources/script/myreservation.js"></script>
    </body>
</html>